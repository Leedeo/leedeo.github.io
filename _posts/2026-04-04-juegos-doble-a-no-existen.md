...
description: "El término doble A o AA no define ninguna categoría real con identidad propia. Es una operación de marketing para empaquetar mejor decisiones empresariales de reducción de presupuestos."
excerpt: "Cada cierto tiempo la industria se inventa una etiqueta nueva. El doble A no existe como categoría real: existe como discurso para venderte lo mismo con otro envoltorio."
...
Hace un tiempo publiqué un artículo sobre [qué es un juego indie y por qué la industria no sabe definirlo bien](/blog/que-es-un-juego-indie-definicion/), y ahí ya se veía un problema parecido: la tendencia constante a estirar las etiquetas hasta que dejan de significar algo.
