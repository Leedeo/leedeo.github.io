...
description: "La cifra de 10.000 wishlists se repite como dogma en el desarrollo indie, pero nadie explica qué significa realmente ni por qué puede convertirse en una trampa mental para los desarrolladores."
excerpt: "Las wishlists importan, pero si no entiendes qué estás mirando, pueden hacerte perder meses persiguiendo humo. La cifra de 10.000 no es una garantía, es una trampa."
...
video:
  ...
  description: "Cómo hacer un tráiler de videojuego que venda y no haga que tu juego pase desapercibido en Steam."
  upload_date: "2023-07-16"
  duration: "PT3M51S"
faq:
  - question: "¿Cuántas wishlists se necesitan en Steam para tener éxito?"
    answer: "No existe una cifra mágica. La recomendación habitual de 10.000 wishlists es una media orientativa, pero lo que realmente importa es la calidad de esas wishlists: si vienen de gente que realmente conoce y quiere tu juego, convertirán mucho mejor que una lista de clics distraídos."
  - question: "¿Qué porcentaje de wishlists se convierte en ventas?"
    answer: "Depende totalmente de cómo se consiguieron. Wishlists de una comunidad comprometida pueden convertir al 20-40% o más. Wishlists genéricas de eventos o tráfico frío pueden convertir menos del 5%. Steam no distingue entre ambas, pero la diferencia en ventas reales es abismal."
  - question: "¿Por qué las wishlists no garantizan ventas?"
    answer: "Porque una wishlist no es un compromiso de compra. Solo significa que alguien pulsó un botón en un momento concreto. La gente olvida, cambia de intereses, pierde el interés con el tiempo o simplemente añade juegos por inercia sin intención real de comprarlos."
  - question: "¿Qué diferencia a una wishlist de calidad de una que no vale nada?"
    answer: "Una wishlist de calidad viene de alguien que conoce tu juego, ha visto su desarrollo, ha probado una demo o ha interactuado con tu comunidad. Una wishlist vacía viene de alguien que vio una captura bonita, pasó por tu página en un evento o la añadió sin entender realmente qué era el juego."
  - question: "¿Cómo conseguir wishlists que realmente se conviertan en ventas?"
...
![Captura de pantalla del panel de Steamworks mostrando el contador de wishlists de un juego indie, con la cifra destacada en la parte superior de la interfaz.](/assets/img/posts/wishlists-steam-counter.webp)
...
[**The Last Night**](https://store.steampowered.com/app/612400/The_Last_Night/) es un caso clarísimo de cómo una wishlist también puede ser una promesa caducada. El juego generó una atención brutal. Muchísima gente lo añadió. Años después, sigue sin salir.
...
[**Replaced**](https://store.steampowered.com/app/1372180/Replaced/) también ayuda a ver otro lado del problema. Muchísima atención visual, muchísima conversación, muchísima estética que entra por los ojos. Pero una cosa es captar atención y otra muy distinto convertirla en una compra cuando el juego sale.

Y luego están los casos que rompen el relato, como [**Balatro**](https://store.steampowered.com/app/2379780/Balatro/), [**Vampire Survivors**](https://store.steampowered.com/app/1794680/Vampire_Survivors/) o incluso [**Among Us**](https://store.steampowered.com/app/945360/Among_Us/), que demuestran que no siempre gana quien tiene la preparación más *"correcta"* según manual.
