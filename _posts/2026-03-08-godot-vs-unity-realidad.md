...
- El código del motor es auditable. Si encuentras un bug crítico, puedes ir directamente al repositorio en GitHub, leer el código, entender la causa e incluso enviar un fix. No esperas a que \"el equipo de Unity decida si eso es un bug o una feature\".
...
No elijas un motor por las promesas de empleo de un desconocido en Twitter. Elige una herramienta que te dé la libertad de crear sin condiciones y que te enseña cómo funciona lo que estás haciendo.
